...
POLARIS_API extern size_t precomputed_table_max_bytes;
...
POLARIS_API extern int index_ivfpq_add_core_o_bs;
...
POLARIS_API extern IndexIVFPQStats indexIVFPQ_stats;
