...
#if defined(_MSC_VER)
#define POLARIS_PRAGMA_IMPRECISE_LOOP
#define POLARIS_PRAGMA_IMPRECISE_FUNCTION_BEGIN \
    __pragma(float_control(precise, off, push))
#define POLARIS_PRAGMA_IMPRECISE_FUNCTION_END __pragma(float_control(pop))
...
#define POLARIS_PRAGMA_IMPRECISE_FUNCTION_END _Pragma("float_control(pop)")
#else
#define POLARIS_PRAGMA_IMPRECISE_FUNCTION_BEGIN
#define POLARIS_PRAGMA_IMPRECISE_FUNCTION_END
#endif
