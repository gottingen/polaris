...
#include <polaris/faiss/utils/hamming_distance/common.h>

#ifdef __aarch64__
// ARM compilers may produce inoptimal code for Hamming distance somewhy.
#include <polaris/faiss/utils/hamming_distance/neon-inl.h>
#elif __AVX2__
// better versions for GenHammingComputer
#include <polaris/faiss/utils/hamming_distance/avx2-inl.h>
#else
#include <polaris/faiss/utils/hamming_distance/generic-inl.h>
#endif
