...
#include <polaris/faiss/utils/distances_fused/distances_fused.h>

#include <polaris/utility/platform_macros.h>

#include <polaris/faiss/utils/distances_fused/avx512.h>
#include <polaris/faiss/utils/distances_fused/simdlib_based.h>
