...
#pragma omp parallel for
        ...
        static void
        removeShortcutEdges(NGT::GraphIndex &outGraph, int &removeCount, float range, size_t nOfThreads = 0) {
...
#pragma omp parallel for
        ...
        static
        void
        reconstructGraph(std::vector<NGT::ObjectDistances> &graph, NGT::GraphIndex &outGraph, size_t originalEdgeSize,
        ...
        static void
        refineANNG(NGT::Index &index, bool unlog, float epsilon = 0.1, float accuracy = 0.0, int noOfEdges = 0,
