...
namespace polaris {
    ...
    public:
        ...
        class Container : public polaris::Container {
        public:
            Container(Object &f, ObjectID i) : polaris::Container(f, i) {}
        ...
        public:
            ...
            SearchContainer(Object &f, ObjectID i) : polaris::SearchContainer(f, i) {}

            SearchContainer(Object &f) : polaris::SearchContainer(f, 0) {}
        ...
        void deleteInMemory() {
            for (std::vector<polaris::LeafNode *>::iterator i = leafNodes.begin(); i != leafNodes.end(); i++) {
                if ((*i) != 0) {
                    delete (*i);
                }
            }
            leafNodes.clear();
            for (std::vector<polaris::InternalNode *>::iterator i = internalNodes.begin();
                 i != internalNodes.end(); i++) {
                if ((*i) != 0) {
                    delete (*i);
                }
            }
