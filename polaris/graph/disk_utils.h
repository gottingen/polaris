...
POLARIS_API std::string preprocess_base_file(const std::string &infile, const std::string &indexPrefix,
                                                   polaris::Metric &distMetric);

template <typename T, typename LabelT = uint32_t>
POLARIS_API int build_merged_vamana_index(std::string base_file, polaris::Metric _compareMetric, uint32_t L,
...
POLARIS_API int build_disk_index(
    ...
    polaris::Metric _compareMetric, bool use_opq = false,
